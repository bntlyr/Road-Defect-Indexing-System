...
class Statistics(QGroupBox):
    ...
    def update_defect_count(self, count):
        """Update the defect count display"""
        self.donut_linear.count = count.get('linear', 0)
        self.donut_alligator.count = count.get('alligator', 0)
        self.donut_pothole.count = count.get('pothole', 0)
        self.donut_linear.update()
        self.donut_alligator.update()
        self.donut_pothole.update()

    def reset(self):
        """Reset all statistics"""
        self.lat_label.setText("Latitude: --")
        self.lon_label.setText("Longitude: --")
        self.donut_linear.count = 0
        self.donut_alligator.count = 0
        self.donut_pothole.count = 0
        self.donut_linear.update()
        self.donut_alligator.update()
        self.donut_pothole.update()
